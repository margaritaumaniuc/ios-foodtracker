 ...
 *
 * @return Returns nil if a variable of another type already exists with this name.
 */
 ...
 *
 * @see getStringDictionaryForName:
 *
 * @param name The name of the dynamic variable to create.
 ...
 *
 * @see getIntegerDictionaryForName:
 *
 * @param name The name of the dynamic variable to create.
 ...
 *
 * @see getDoubleDictionaryForName:
 *
 * @param name The name of the dynamic variable to create.
 ...
 *
 * @see stringWithName:andDefaultString:
 *
 ...
 *
 * @return Returns nil if no such variable exists with this name.
 */
 ...
 *
 * @see boolWithName:andDefaultBool:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see integerWithName:andDefaultInteger:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see doubleWithName:andDefaultDouble:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see stringArrayWithName:andDefaultStringArray:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see boolArrayWithName:andDefaultBoolArray:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see integerArrayWithName:andDefaultIntegerArray:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see doubleArrayWithName:andDefaultDoubleArray:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see stringDictionaryWithName:andDefaultStringDictionary:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see boolDictionaryWithName:andDefaultBoolDictionary:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see integerDictionaryWithName:andDefaultIntegerDictionary:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
 ...
 *
 * @see doubleDictionaryWithName:andDefaultDoubleDictionary:
 *
 * @param name The name of the dynamic variable to retrieve.
 *
...
/**
  * @brief Retrieves the string value of this ApptimizeVariableString.
  *
  ...
  *
  * @return Returns the default value if there is an issue with the incoming variant data.
  */
...
/**
 * @brief Retrieves the bool value of this ApptimizeVariableBool.
 *
...
/**
 * @brief Retrieves the signed integer value of this ApptimizeVariableInteger.
 *
...
/**
 * @brief Retrieves the unsigned integer value of this ApptimizeVariableInteger.
 *
 * @return Returns the default integer provided at construction if no variant has been received
 *         from the servers, or the variant integer if enrolled in a particular variant.
 *
...
/**
 * @brief Retrieves the double value of this ApptimizeVariableDouble.
 *
...
/**
 * @brief Retrieves the array of this ApptimizeVariableArray.
 *
...
/**
 * @brief Retrieves the dictionary of this ApptimizeVariableDictionary.
 *
